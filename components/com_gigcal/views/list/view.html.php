 ...
 */
class GigCalViewList extends JView
{
  public $config;
  ...
  function display($tpl = null) 
  {
    ...
    $db->setQuery('SELECT SQL_CALC_FOUND_ROWS g.* FROM #__gigcal_gigs g WHERE published=1'
		.' AND gigdate > '.time()
		.' ORDER BY gigdate', $this->limitstart, $this->limit);
