...
class plgContentfb_tw_plus1 extends JPlugin {
  ...
  private function getPlugInCommentsHTML($params, $article, $url, $title) {
    ...
    if ($container_comments==1){
      $htmlCode .="<div id=\"".$idrnd."\" class=\"cmp_comments_container clearfix\" $css_comments>";
    } elseif ($container_comments==2) {
      $htmlCode .="<p id=\"".$idrnd."\" class=\"cmp_comments_container clearfix\" $css_comments>";
    }
  ...
  private function getPlugInButtonsHTML($params, $article, $url, $title) {
    ...
    if ($container_buttons==1){
      $htmlCode ="<div class=\"cmp_buttons_container clearfix\" $css_buttons>";
    } elseif ($container_buttons==2) {
      $htmlCode ="<p class=\"cmp_buttons_container clearfix\" $css_buttons>";
    }
    //FB like button
    if ($enable_like == 1) {
