...
class JElementResolution extends JElement
{
	...
	*/
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		// because Joomla! 1.5 doesn't behave quite right with params and we don't want to keep this whole HTML code in the language files, we need to make this ugly workaround
