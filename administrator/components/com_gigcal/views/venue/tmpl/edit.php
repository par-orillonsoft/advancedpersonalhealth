...
<form action="<?php echo JRoute::_('index.php?option=com_gigcal&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="venue-form" class="form-validate">
  <div class="width-60 fltlft">
    <fieldset class="adminform">
      <legend><?php echo empty($this->item->id) ? JText::_('COM_GIGCAL_NEW_VENUE') : JText::sprintf('COM_GIGCAL_EDIT_VENUE', $this->item->id); ?></legend>
      <ul class="adminformlist">
        <li><?php echo $this->form->getLabel('venuename'); ?>
        <?php echo $this->form->getInput('venuename'); ?></li>
        ...
        <li><?php echo $this->form->getLabel('zip'); ?>
