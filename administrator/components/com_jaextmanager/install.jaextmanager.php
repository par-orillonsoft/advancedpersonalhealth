...
function com_install() {
 ...
 <div style="text-align:left;">
  	<table width="100%" border="0">
	    <tr>
	      <td>
	      		<img src="components/com_jaextmanager/assets/images/jauc.png" />
	      		JA Extensions Manager is installed successfully!<br />
                Successfully installed What's next? <br />
                ------------------ <br />
                1. Read <a href="#user-guide" title="">userguide</a> below CAREFULLY <br />
                2. <a href="index.php?option=com_jaextmanager&view=services" target="_blank" title="Configure update service settings">Configure update service settings</a> <br />
                +++++++++++++++++++++++++++++++++++++++++ ]<br />
                <a name="user-guide"></a>
                <fieldset>
                ...
                <p><strong>JoomlArt Extension Manager - Version - 1.1.2</strong></p>
				...
				<a href="http://wiki.joomlart.com/wiki/JA_Extensions_Manager/Overview" target="_blank" title="Read more">Read more</a>
	      </td>
	    </tr>
    </table>
 </div>
